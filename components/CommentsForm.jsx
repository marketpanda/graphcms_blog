...
const CommentsForm = ({slug}) => {
    ...
    return (
        <div className="bg-white shadow-lg rounded-lg p-8 pb-12 mb-8">
            <h3 className='text-xl mb-8 font-semibold border-bottom pb-4'>Leave a Reply</h3>
            ...
            <div className='grid grid-cols-1 gap-4 mb-4'>
                <div>
                    ...
                    <label className='text-gray-500 cursor-pointer'>Save my Email and Name for the next time I comment</label>
                </div>
            </div>
             {error && <p className='text-xs hex-ss text-red-500 '>All fields are requried</p>}
             <div className='mt-8 '>
